...
class SocketCollectionViewController: UICollectionViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UIAlertViewDelegate  {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
			...
			//data source
			cv_items.append(view_socket(name: "One", image: UIImage(named: "help"), active: true))
			cv_items.append(view_socket(name: "Two", image: UIImage(named: "help"), active: true))
			cv_items.append(view_socket(name: "Three", image: UIImage(named: "help"), active: true))
			cv_items.append(view_socket(name: "Four", image: UIImage(named: "help"), active: true))
			cv_items.append(view_socket(name: "Five", image: UIImage(named: "help"), active: true))
			cv_items.append(view_socket(name: "Six", image: UIImage(named: "help"), active: true))
